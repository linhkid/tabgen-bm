...
# Fix imports to use relative or absolute paths
# Used for pre/post-processing of the input/generated data
from ctabgan.model.pipeline.data_preparation import DataPrep 
# Model class for the CTABGANSynthesizer
from ctabgan.model.synthesizer.ctabgan_synthesizer import CTABGANSynthesizer 
